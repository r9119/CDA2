...
call <- "https://apidatos.ree.es/en/datos/generacion/potencia-instalada?start_date=2018-01-01T00:00&end_date=2018-12-31T23:59&time_trunc=month"
data <- get_data(call)
included <- data$included
View(included)
d <- filter(included, type == 'Hydro')
d$attributes.values
```
